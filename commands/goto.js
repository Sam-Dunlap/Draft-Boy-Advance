...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('goto')
        .setDescription('Use this command to move the draft to a specific pick number.')
    ...
    async execute(interaction) {
        ...
        if (!pickNumber) {
            await interaction.reply({content: `Skipping 1 player` , ephemeral: true});
