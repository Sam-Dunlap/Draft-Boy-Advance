...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('poll')
        .setDescription('Poll for rule changes. Use `Apps => Close` in context menu to record results.')
        ...
        .addBooleanOption(o => 
            o.setName('hidden')
            .setDescription('hide results until poll closes - default false'))
        .addBooleanOption(o =>
            o.setName('multivote')
    ...
    async execute(interaction) {
        ...
        const responseChannel = await interaction.client.channels.cache.get(interaction.channelId);
